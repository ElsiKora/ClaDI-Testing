...
const config = {
	...
	repositoryUrl: "https://github.com/ElsiKora/ClaDI-Testing",
};

const isPrereleaseBranch = config.branches.some((currentBranch) => typeof currentBranch === "object" && branch.includes(currentBranch.name) && currentBranch.prerelease);
